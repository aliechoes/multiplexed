    ...
    def transform(self,X):
        ...
        for pr in proteins:
            ...
            if indx.sum() > 0:	
                ...
                features["AS_volume_" + str(self.alpha) + "_" + pr] = alpha_shape_pr.volume
                features["AS_area_" + str(self.alpha) + "_" + pr] = alpha_shape_pr.area
                alpha_shape_pr = None
            else:
                features["AS_volume_" + str(self.alpha) + "_" + pr] = 0.
                features["AS_area_" + str(self.alpha) + "_" + pr] = 0.
